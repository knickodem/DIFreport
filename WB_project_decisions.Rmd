...
Comparing results from our code to using the difR package as a sensitivity check
 ...
 - Also a bit difficult to determine what is going on "under the hood". Need to review the workhorse functions to determine what procedures are exactly being used, and how many tests are conducted, etc...
