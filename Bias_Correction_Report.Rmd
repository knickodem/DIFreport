...
**Items with no within group variance:^b^** `r nvgi`
...
^a^ Items were not included in the DIF analysis nor the IRT-based treatment effect robustness check

^b^ Items were not included in the IRT-based DIF analysis nor the IRT-based treatment effect robustness check
...
if(!is.character(BIs)){
  ...
  cat("&nbsp;  ")
  cat("*Note:* Adj. Delta  = Raw Delta / sqrt(Reliability)")
...
if(!is.null(DIF_Results$loess)){
  cat("## Descriptive analyis via Loess")
  cat("\n\n")
