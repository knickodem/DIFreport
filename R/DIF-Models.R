...
#'
#' An interim function between dif_analysis and effect_robustness
#'
...
#'
#' @return A named \code{list} containing the data and IRT models to estimate treatment effects.

dif_models <- function(dif.analysis, dif.data = NULL, biased.items = "IRT"){
