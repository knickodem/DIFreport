...
**Comparison groups:** `r paste(outputs$dif.group1, outputs$dif.group2, sep = " and ")`
...
if(dif.type == "uniform"){
  ...
  cat("* Number of items uniformly biased toward ", outputs$dif.group1, ": ", toward[[1]], sep = "")
  cat("\n\n")
  cat("* Number of items uniformly biased toward ", outputs$dif.group2, ": ", toward[[2]], sep = "")
  }
}
```
