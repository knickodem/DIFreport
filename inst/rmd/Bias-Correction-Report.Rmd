...
```{r Summary Table, results='asis', warning=FALSE, ft.align="left", fig.width = 5, fig.height = 4}
...
if(is.null(tx.group)){
  ...
  cat(knitr::knit_print(condeff1tab))
  cat("\n\n")
  cat("&nbsp;  ")
  cat("*Note:* Adj. Delta  = Total Delta / sqrt(Reliability)")
  cat("\n\n")
  ...
  cat(knitr::knit_print(condeff2tab))
  cat("\n\n")
  cat("&nbsp;  ")
  cat("*Note:* Adj. Delta  = Total Delta / sqrt(Reliability)")
  cat("\n\n")
  ...
  print(cond.effects2$effects.plot)
